...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function promptForNameAndEmail() {
        ...
        `,
            ...
            if (result && result.dismiss !== "cancel") {
                ...
                const finalName = name || "Fasumas ";
                const finalEmail = email || "fasumas@gmail.com";
    ...
    if (
        preferences.name === "Fasumas" &&
        preferences.email === "fasumas@gmail.com"
    ) {
